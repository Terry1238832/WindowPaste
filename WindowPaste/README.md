...
macOS 菜单栏小工具。按下 **⌘·**（默认，Esc 正下方，可在设置里改）后，会截取 LetsView 或其他指定软件的窗口，复制到剪贴板，并粘贴到当前光标位置。
...
1. 从 [Releases](../../releases/latest) 下载 `WindowPaste-1.0.1.dmg`
